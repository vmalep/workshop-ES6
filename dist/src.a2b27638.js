...
function submitSearch() {
  ...
  var selectedHouses = _houseToRent.default.filter(function (house) {
    return !(!house.available && onlyAvailable) && (homeType === "All" || house.type === homeType);
  });
  ...
  for (var i = 0; i < selectedHouses.length; i++) {
    (0, _createCard.createCard)(selectedHouses[i]);
  }
}
...
searchInput.addEventListener("keypress", function (e) {
  if (e.key === "Enter") {
    ...
    searchInputArray.forEach(function (element) {
      console.log(element);
    });
  }
});
...
var houseTypeSelect = document.querySelector(".select");
...
var availableCheckBox = document.querySelector(".available-checkbox");
...
submitSearch();
},{"./houseToRent":"src/houseToRent.js","./createCard":"src/createCard.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
